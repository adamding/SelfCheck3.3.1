...
1) E(X)= <span class='answer'>`r sum(seq(100)*seq(100)^2/338350)`</span>
...
2) sd(X)= <span class='answer'>`r sqrt(sum((x-EX)^2*x^2/338350))`</span>
...
1) E(X)= <span class='answer'> `r EX` </span>
...
2) Var(X)= <span class='answer'> `r VarX`</span>
...
1) E(X)= <span class='answer'> `r 3*1+2` </span>

E(X)=3(1)+2=5

2) Var(X)= <span class='answer'> `r 3^2*4`</span>
...
```r echo = F
EY<-integrate(function(x) x*exp(-x), lower=0, upper=Inf)$value 
VarY<-integrate(function(x) (x-EY)^2*exp(-x), lower=0, upper=Inf)$value 
```

*** .explanation

1) E(Y)= <span class='answer'> `r EY` </span>

E(Y)=$\int_0^\infty y*exp(y)dy$ =1

integrate(function(x) x*exp(-x), lower=0, upper=Inf)$value 

2) Var(Y)= <span class='answer'> `r VarY`</span>

Var(Y)=$\int_0^\infty (y-1)^2*exp(y)dy$ =1

integrate(function(x) (x-1)\^2*exp(-x), lower=0, upper=Inf)$value 

3) E(X)= <span class='answer'> `r 5*1-4` </span>

E(X)=5*E(X)-4=5(1)-4=1

4) Var(X)= <span class='answer'> `r 25*VarY`</span>
